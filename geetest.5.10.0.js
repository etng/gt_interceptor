...
!function(a, b) {
    ...
    S.P = function(a, b) {
        ...
        c.config.mobile ? c.dom.className = "gt_mobile_holder " + c.config.product : c.dom.className = "gt_holder gt_" + c.config.product,
    ...
    var ma = function(a) {
      ...
      , na = function() {
        var a = function(a, b) {
          ...
          , f = function(a) {
            var plain = JSON.stringify(Q.t("arr", a))
            // console.log('before na.qa:', a)
            // return JSON.stringify(Q.t("arr", a))
            // console.log(Q.t("arr", a))
            // console.log(c(Q.t("arr", a)))
            for (var b, f = c(Q.t("arr", a)), g = [], h = [], i = [], j = 0, k = f.length; j < k; j++)
                b = e(f[j]),
                b ? h.push(b) : (g.push(d(f[j][0])),
                h.push(d(f[j][1]))),
                i.push(d(f[j][2]));
            return {plain:plain, encoded: g.join("") + "!!" + h.join("") + "!!" + i.join("")}
        };
        return {
            qa: f,
            na: b,
